    ...
    if (settingsPanel && !document.getElementById('resetSettingsDefaultsBtn')) {
        ...
        resetSection.innerHTML = `
            <button id="resetSettingsDefaultsBtn" type="button"
                ...
                class="w-full px-4 py-3 bg-neutral-800 hover:bg-neutral-700 rounded-lg text-sm font-medium text-neutral-300 hover:text-white transition-colors border border-neutral-700 flex items-center justify-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
